const addPricesToModel = (modelName: string, categories: any[]) => {
  ...
  const model3Pricing = {
    ...
    4: { "Si": 184, "No": 0 },
    5: { "Si": 209, "No": 0 },
    6: { "Bahama Mate": 0, "Tampa": 0, "Tany Sand": 0 },
    7: { "Bahama Mate": 0, "Tampa": 0, "Tany Sand": 0 },
    8: { "Bahama Mate": 0, "Tampa": 0, "Tany Sand": 0 },
    9: { "London Ash": 0, "Geo avorio": 0, "Martin Blanco": 0 },
    10: { "London Ash": 0, "Geo avorio": 0, "Martin Blanco": 0 },
    11: { "Si": 868, "No": 0 },
    12: { "Sala principal": 43, "Comedor": 43, "Fregadero 1": 43, "Fregadero 2": 43, "Cocina": 43, "Entrada": 43 },
    13: { "Cuarto Principal": 43, "Pasillo": 43, "Escalera": 43 },
    14: { "Si": 1069, "No": 0 },
    20: { "Si": 660, "No": 0 },
    21: { 
  ...
  const modelPricing: any = {
    Modelo_1: {
      ...
      10: { "London Ash": 0, "Geo avorio": 0, "Martin Blanco": 0 },
      11: { "Si": 868, "No": 0 },
      12: { "Comedor": 43, "Sala primer nivel": 43 },
      13: { "Cuarto Principal": 43, "Pasillo": 43, "Escalera": 43 },
      20: { "Si": 404, "No": 0 },
      21: { 
        "Granito Blanco Báltico": 0, "Granito Gran Perla": 0,
    ...
    Modelo_2: {
      ...
      13: { "Si": 841, "No": 0 },
      14: { "Sala principal": 43},
      15: { "Cuarto Principal": 43, "Escalera": 43, "Pasillo": 43 },
      16: { "Si": 497, "No": 0 },
      17: { "Si": 973, "No": 0 },
      20: { "Si": 514, "No": 0 },
      21: { 
        ...
        questions: [
          {
            ...
            options: [
              ...
              { name: "Roble provenzal", image: "/Naala_assets/Acabados_de_Muebles/Roble Provenzal.jpg" },
              { name: "Roble rustico", image: "/Naala_assets/Acabados_de_Muebles/Roble Rustico.jpeg" },
            ], 
          },
          {
            id: 2,
        ...
        questions: [
          {
            ...
            options: [
              ...
              { name: "Tampa 60x60", image: "/Naala_assets/Acabados/Tampa.jpeg" },
