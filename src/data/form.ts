const addPricesToModel = (modelName: string, categories: any[]) => {
  ...
  const model3Pricing = {
    ...
    4: { "Si": 193, "No": 0 },
    5: { "Si": 207, "No": 0 },
    6: { "Norwich Perla Mate": 0, "Inter Mate": 0, "Belen Marfil": 0 },
    7: { "Norwich Perla Mate": 0, "Inter Mate": 0, "Belen Marfil": 0 },
    8: { "Norwich Perla Mate": 0, "Inter Mate": 0, "Belen Marfil": 0 },
